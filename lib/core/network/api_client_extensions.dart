...
extension ApiClientDriverExtension on ApiClient {
  Future<dynamic> getDriver(String path, {Map<String, dynamic>? queryParameters, Options? options}) async {
  ...
  Future<dynamic> postDriver(String path, {dynamic data, Map<String, dynamic>? queryParameters, Options? options}) async {
  ...
  Future<dynamic> putDriver(String path, {dynamic data, Map<String, dynamic>? queryParameters, Options? options}) async {
  ...
  Future<dynamic> deleteDriver(String path, {dynamic data, Map<String, dynamic>? queryParameters, Options? options}) async {
