...
class PassengerQueueScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<PassengerQueueScreen> createState() =>
      _PassengerQueueScreenState();
}
...
class RealtimeQueueScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<RealtimeQueueScreen> createState() =>
      _RealtimeQueueScreenState();
}
                ...
                (context, index) {
                  ...
                  return Padding(
                    ...
                    child: QueueVehicleCard(
                      ...
                      isPending:
                          isPending && queueState.pendingSelection!.isPending,
                      onTap: () => _onVehicleSelected(vehicle),
                    ),
                  );
                },
