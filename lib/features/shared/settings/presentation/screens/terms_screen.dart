        ...
        child: Column(
          ...
          children: [
            ...
            _buildSection(
              ...
              content:
                  '''By accessing or using the Komiut application, you agree to be bound by these Terms of Service. If you do not agree to these terms, please do not use our services.
...
These terms apply to all users of the app, including passengers, drivers, and SACCO operators.''',
            ...
            _buildSection(
              ...
              content:
                  '''Komiut provides a platform that connects passengers with public transport vehicles (matatus, buses) operated by registered SACCOs. We facilitate:
...
Our liability is limited to the amount you paid for the specific service.''',
            ...
            _buildSection(
              ...
              content:
                  '''All content, features, and functionality of the Komiut app are owned by Komiut and protected by intellectual property laws. You may not:
...
• Subject to the jurisdiction of Kenyan courts''',
            ...
            _buildSection(
              ...
              content:
                  '''We reserve the right to modify these terms at any time. We will notify users of significant changes through the app or email. Continued use after changes constitutes acceptance of the new terms.''',
            ),
            _buildSection(
              context: context,
              title: '11. Contact',
