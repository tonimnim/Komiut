...
class FaqScreen extends StatelessWidget {
  ...
  static const List<_FaqItem> _faqItems = [
    _FaqItem(
      ...
      answer:
          'To book a matatu, go to the home screen and search for your route. '
    ...
    _FaqItem(
      ...
      answer:
          'The queue system shows you the order of vehicles waiting to depart. '
    ...
    _FaqItem(
      ...
      answer:
          'We accept M-Pesa, wallet balance, and cash (at selected routes). '
    ...
    _FaqItem(
      ...
      answer:
          'Go to your wallet section from the home screen and tap "Top Up". '
    ...
    _FaqItem(
      ...
      answer:
          'We provide real-time updates on vehicle status. If there\'s a significant delay, '
    ...
    _FaqItem(
      ...
      answer:
          'You can reach our support team through the Help & Support section in Settings. '
