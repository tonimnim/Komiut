...
final nearbyRoutesProvider =
    FutureProvider.family<List<RouteEntity>, UserLocation>(
  (ref, location) async {
...
final nearbyRoutesWithRadiusProvider = FutureProvider.family<List<RouteEntity>,
...
List<RouteEntity> _filterRoutesByProximity(
    List<RouteEntity> routes, UserLocation location,
  ...
  return routes.where((route) {
    ...
    final routeText =
        '${route.name} ${route.startPoint} ${route.endPoint}'.toLowerCase();
