...
class TopupStateNotifier extends StateNotifier<TopupState> {
  ...
  static const int _maxPollAttempts =
      60; // 60 attempts at 3 seconds = 3 minutes
...
final walletTransactionsProvider =
    FutureProvider.family<List<WalletTransaction>, int>((ref, offset) async {
...
final allTransactionsProvider = StateNotifierProvider<AllTransactionsNotifier,
