...
class _PaymentMethodScreenState extends ConsumerState<PaymentMethodScreen> {
                  ...
                  children: [
                    ...
                    if (walletBalance > 0 && !hasSufficientBalance)
                      PaymentMethodCard(
                        ...
                        subtitle:
                            'Use wallet ($_currency ${walletBalance.toStringAsFixed(0)}) + M-Pesa',
                        onTap: () {
                          setState(() {
                    ...
                    if (_selectedMethod == PaymentMethodType.mpesa ||
                        _useSplitPayment) ...[
                      Text(
                        'M-Pesa Phone Number',
                        style: TextStyle(
            ...
            _PaymentBottomBar(
              amount: _useSplitPayment
                  ...
                  : (_selectedMethod == PaymentMethodType.wallet
                      ...
                      : _bookingAmount),
              currency: _currency,
              paymentMethod: _useSplitPayment
                  ? 'Split Payment'
  ...
  void _processPayment(BuildContext context) {
    ...
    context
        .push(RouteConstants.passengerPaymentProcessingPath(widget.bookingId));
  }
}
