...
class _RedeemPointsSheetState extends ConsumerState<RedeemPointsSheet> {
  ...
  void _calculateMaxPoints() {
    ...
    if (widget.bookingAmount != null) {
      final maxForBooking =
          LoyaltyRules.pointsForDiscount(widget.bookingAmount!);
  ...
  double get _discountValue =>
      LoyaltyRules.calculateRedemptionValue(_selectedPoints);
                ...
                child: ElevatedButton(
                  onPressed: _canRedeem && !redeemState.isLoading
                      ? () async {
                          ...
                          final success =
                              await notifier.redeem(widget.bookingId);
                          if (success && mounted) {
                            widget.onRedeemed
                                ?.call(_selectedPoints, _discountValue);
