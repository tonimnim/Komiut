      ...
      child: Column(
        ...
        children: [
          ...
          const _HowItWorksItem(
            ...
            title: 'Redeem',
            description:
                'Use 100 points for KES 10 discount on your next booking',
          ),
          const SizedBox(height: 16),
          const _HowItWorksItem(
            ...
            title: 'Level Up',
            description:
                'Earn more points to unlock higher tiers with bonus rewards',
          ),
          const SizedBox(height: 16),
          const _HowItWorksItem(
            icon: Icons.star,
            title: 'Tier Bonuses',
            description:
                'Higher tiers earn bonus points: Silver 5%, Gold 10%, Platinum 15%',
          ),
        ],
      ),
    );
