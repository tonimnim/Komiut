...
class LoyaltyScreen extends ConsumerWidget {
  ...
  Widget _buildContent(
      BuildContext context, WidgetRef ref, LoyaltyPoints? loyalty) {
    final theme = Theme.of(context);
    final isDark = theme.brightness == Brightness.dark;
  ...
  void _showRedeemSheet(BuildContext context, int availablePoints) {
    RedeemPointsSheet.show(
      ...
      bookingId:
          'demo-booking', // In real app, this would be an actual booking ID
      onRedeemed: (points, discount) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(
                'Redeemed $points points for KES ${discount.toStringAsFixed(0)} discount!'),
            ...
            children: [
              ...
              Text(
                ...
                style: TextStyle(
                  ...
                  color:
                      onTap != null ? theme.colorScheme.onSurface : Colors.grey,
                ),
              ),
            ],
          ),
