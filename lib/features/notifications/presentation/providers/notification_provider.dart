...
final notificationsProvider = StateNotifierProvider<NotificationNotifier, AsyncValue<List<NotificationEntity>>>((ref) {
  ...
  List<NotificationEntity> _generateMockNotifications() {
    ...
    return [
      NotificationEntity(
        ...
        message: 'Your trip from Nairobi CBD to Westlands has been completed. Fare: KES 120',
      ...
      NotificationEntity(
        id: '4',
        title: 'Trip Completed',
        message: 'Your trip from Westlands to Karen has been completed. Fare: KES 350',
        type: NotificationType.trip,
