...
class SavedRoutesScreen extends ConsumerWidget {
  ...
  void _showRouteOptions(BuildContext context, WidgetRef ref, SavedRoute route) {
    final theme = Theme.of(context);
          ...
          child: Column(
            ...
            children: [
              ...
              ListTile(
                ...
                onTap: () {
                  Navigator.pop(context);
                  ref.read(savedRoutesProvider.notifier).removeRoute(route.routeId);
                },
              ),
            ],
          ),
  ...
  void _showEditNameDialog(BuildContext context, WidgetRef ref, SavedRoute route) {
