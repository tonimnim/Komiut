...
class PassengerPreferencesNotifier extends StateNotifier<PassengerPreferencesState> {
  ...
  Future<void> updateAccessibilityOption({
    ...
    try {
      ...
      state = state.copyWith(error: 'Failed to update accessibility options: $e');
    }
  }
...
final passengerPreferencesProvider =
    StateNotifierProvider<PassengerPreferencesNotifier, PassengerPreferencesState>(
  (ref) {
...
class SavedPaymentMethodsNotifier
  ...
  SavedPaymentMethodsNotifier(this._repository) : super(const AsyncValue.loading()) {
    _loadMethods();
  }
