        ...
        actions: [
          ...
          if (_showPassengerCount(bookingState.currentStep))
            _PassengerCountButton(
              ...
              onChanged: (count) {
                ref.read(bookingFlowProvider.notifier).updatePassengerCount(count);
              },
            ),
        ],
      ),
  ...
  Widget _buildStepContent(BookingFlowState state) {
    switch (state.currentStep) {
      case BookingFlowStep.selectRoute:
        ...
        WidgetsBinding.instance.addPostFrameCallback((_) {
          ref.read(bookingFlowProvider.notifier).goToStep(BookingFlowStep.selectStops);
        });
      ...
      case BookingFlowStep.reviewBooking:
        return Padding(
          ...
          child: BookingReview(
            ...
            onEditVehicle: () {
              ref.read(bookingFlowProvider.notifier).goToStep(BookingFlowStep.selectVehicle);
            },
            onEditSeats: () {
              ref.read(bookingFlowProvider.notifier).goToStep(BookingFlowStep.selectSeats);
            },
          ),
        );
      ...
      child: SafeArea(
        child: Row(
          children: [
            ...
            // Next button
            Expanded(
              flex: onSkip != null || !_showFare(bookingState.currentStep) ? 1 : 0,
