                        ...
                        child: Column(
                          children: [
                            ...
                            ReceiptItem(
                              ...
                              label: 'Date',
                              value: dateFormat.format(_receiptData.transactionDate),
                            ),
                            ReceiptItem(
                              icon: Icons.access_time,
                              iconColor: AppColors.primaryBlue,
                              label: 'Time',
                              value: timeFormat.format(_receiptData.transactionDate),
                            ),
                          ],
                        ),
                      ),
                ...
                SizedBox(
                  ...
                  child: OutlinedButton(
                    ...
                    style: OutlinedButton.styleFrom(
                      padding: const EdgeInsets.symmetric(vertical: 16),
                      side: BorderSide(
                        color: isDark ? Colors.grey[600]! : AppColors.primaryBlue,
                      ),
                      shape: RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(12),
                      ),
