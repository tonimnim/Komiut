          ...
          transactionsAsync.when(
              ...
              return SliverList(
                delegate: SliverChildBuilderDelegate(
                  ...
                  childCount: transactions.length +
                      (ref.read(allTransactionsProvider.notifier).hasMore ? 1 : 0),
                ),
              );
            },
            ...
            error: (error, _) => SliverFillRemaining(
              child: AppErrorWidget(
                ...
                onRetry: () => ref.read(allTransactionsProvider.notifier).refresh(),
              ),
            ),
          ),
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          if (filter == TransactionFilter.all || filter == TransactionFilter.topups)
            Text(
