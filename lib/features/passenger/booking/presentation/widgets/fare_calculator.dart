      ...
      child: Column(
        ...
        children: [
          ...
          if (showBreakdown) ...[
            ...
            _FareRow(
              label:
                  'Per stop (${route.farePerStop.toStringAsFixed(0)} x ${stopsCount - 1})',
              value:
                  '${route.currency} ${(route.farePerStop * (stopsCount - 1)).toStringAsFixed(0)}',
              isSubItem: true,
            ),
            const SizedBox(height: 8),
            _FareRow(
          ...
          return DataRow(
            cells: [
              ...
              ...stops.asMap().entries.map((toEntry) {
                ...
                final isHighlighted =
                    fromIndex == highlightPickup && toIndex == highlightDropoff;
