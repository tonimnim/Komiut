                  ...
                  children: [
                    ...
                    if (ticket.tripInfo.estimatedArrival != null)
                      _DetailRow(
                        ...
                        label: 'Est. Arrival',
                        value: timeFormat
                            .format(ticket.tripInfo.estimatedArrival!),
                      ),
                ...
                _DetailSection(
                  ...
                  children: [
                    _DetailRow(
                      ...
                      label: 'Valid From',
                      value:
                          '${dateFormat.format(ticket.validFrom)} ${timeFormat.format(ticket.validFrom)}',
                    ),
                    _DetailRow(
                      icon: Icons.timer_off_outlined,
                      label: 'Valid Until',
                      value:
                          '${dateFormat.format(ticket.validUntil)} ${timeFormat.format(ticket.validUntil)}',
                    ),
                    if (ticket.usedAt != null)
                      _DetailRow(
                        ...
                        label: 'Boarded At',
                        value:
                            '${dateFormat.format(ticket.usedAt!)} ${timeFormat.format(ticket.usedAt!)}',
                        valueStyle: const TextStyle(
