  ...
  factory TicketModel.fromJson(Map<String, dynamic> json) {
    return TicketModel(
      ...
      routeInfo: RouteInfoModel.fromJson(
        json['routeInfo'] as Map<String, dynamic>? ?? _extractRouteInfo(json),
      ),
      tripInfo: TripInfoModel.fromJson(
        json['tripInfo'] as Map<String, dynamic>? ?? _extractTripInfo(json),
      ),
      pickupStop:
          json['pickupStop'] as String? ?? json['pickupStopName'] as String,
      dropoffStop:
          json['dropoffStop'] as String? ?? json['dropoffStopName'] as String,
