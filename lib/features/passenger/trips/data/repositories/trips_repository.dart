...
import '../../../../shared/home/data/datasources/home_local_datasource.dart';
import '../../../../shared/home/domain/entities/trip_entity.dart';
import '../../../../shared/home/presentation/providers/home_providers.dart';
...
class TripsRepositoryImpl implements TripsRepository {
  ...
  Future<Either<Failure, List<TripEntity>>> _getLocalRecentTrips(
    ...
    try {
      ...
      final numericId = int.tryParse(passengerId) ?? passengerId.hashCode.abs();
      final trips =
          await localDataSource.getRecentTrips(numericId, limit: limit);
      return Right(trips);
    } on CacheException catch (e) {
      return Left(CacheFailure(e.message));
    } catch (e) {
