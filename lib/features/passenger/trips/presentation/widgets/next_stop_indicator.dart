...
class NextStopIndicator extends StatelessWidget {
  ...
  String _calculateETA(RouteStop stop) {
    ...
    final timeDiff =
        stop.estimatedTimeFromStart! - currentStop!.estimatedTimeFromStart!;
    return '$timeDiff min';
  }
}
...
class _AnimatedStopIconState extends State<_AnimatedStopIcon>
  ...
  Widget build(BuildContext context) {
    final color =
        widget.isDestination ? AppColors.success : AppColors.primaryBlue;
            ...
            child: Padding(
              ...
              child: Text(
                ...
                style: TextStyle(
                  fontSize: 14,
                  fontWeight:
                      isDestination ? FontWeight.w600 : FontWeight.normal,
                  color: isDestination
                      ? AppColors.error
