...
/// ```
final tripsProvider = FutureProvider.autoDispose.family<List<TripEntity>, TripsFilter>(
  (ref, filter) async {
...
/// ```
final tripDetailProvider = FutureProvider.autoDispose.family<TripEntity?, String>(
  (ref, tripId) async {
    final repository = ref.watch(tripsRepositoryProvider);
